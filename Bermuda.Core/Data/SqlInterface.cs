...
namespace Bermuda.Core.Data
{
    ...
    //    //ConcurrentDictionary<long, MentionTest> Mentions = new ConcurrentDictionary<long, MentionTest>();
    ...
    //    //public static void InitializeBackgroundDownload(IEndpointLister endpointLister)
    //    //{
    //    //    //var idstr = RoleEnvironment.CurrentRoleInstance.Id.Split('_').LastOrDefault()
    //    //    ForcedRem = endpointLister.GetCurrentInstanceIndex(); //int.Parse(idstr);
    ...
    //    //private void AddMention(MentionTest mention)
    //    //{
    ...
    //    //private static MentionTest GetMentionFromDataReader(SqlDataReader dr)
    //    //{
    ...
    //    //static IEndpointLister EndpointLister = null;
    ...
    //        return new List<IDataProvider>();// StoredSqlInterfaces.Where(x => String.Equals(x.Name.ToLower(), domain.ToLower(), StringComparison.InvariantCultureIgnoreCase));
    //    }
